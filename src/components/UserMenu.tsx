...
import { LogOut, User, History, Shield, Settings, CreditCard } from "lucide-react";
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-56" align="end" forceMount>
          ...
          <DropdownMenuItem onClick={() => setShowCreditPurchaseDialog(true)} className="cursor-pointer">
